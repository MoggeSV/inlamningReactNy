            ...
            <div>
                <form>
                    <div className="form-row">
                        ...
                        <div className="form-group col-md-4">
                            <label htmlFor="middlename">Mellannamn</label>
                            <input type="text" className="form-control" id="middlename" value={this.props.user.middlename} onChange={this.props.onChange} />
                        </div>
                        <div className="form-group col-md-4">
                    ...
                    <div className="form-row">
                        <div className="form-group col-md-12">
                            ...
                            <input type="date" className="form-control" id="birthday" value={this.props.user.birthday} onChange={this.props.onChange} />
                        </div>
                    </div>
